...
import umg.progra2.DataBase.DatabasConnection.Conexion;
...
public class ProductoDao {
    ...
    public List<ProductoModel> obtenerAgrupados(String condicion) throws Exception {
        Connection connection = Conexion.getConnection(); // Usando DatabaseConnection
        String query = "SELECT * FROM tb_producto ORDER BY " + condicion;
